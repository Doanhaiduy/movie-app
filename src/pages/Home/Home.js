...
function Home() {
    ...
    return (
        <Fragment>
            <div
                className={`w-full h-[calc(100vh_-_74px)]  bg-no-repeat bg-cover  ${
            ...
            >
                <div className=" h-[100%] flex items-center justify-center flex-col gap-y-[18px]">
                    <h2 className="text-[5rem]  font-bold text-center max-w-[900px] px-5 drop-shadow-[0_1.2px_1.2px_rgba(255,255,255,0.5)]">
                    ...
                    <div className="flex items-center gap-x-3 mt-12">
                        <Link
                            to={routes.movies}
                            className={`bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-semibold rounded-lg sm:text-[2rem] text-[1rem] px-5 py-[8px] text-center mr-2 mb-2
