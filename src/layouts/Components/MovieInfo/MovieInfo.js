...
function MovieInfo({ currentMovie }) {
    ...
    return (
        <div className=" wrapper grid grid-cols-3 gap-x-[12px] h-[40vh] bg-gray-800 p-[24px] bg-opacity-60 rounded-[24px] backdrop-blur-3xl ">
            <div className="w-full">
                <img
                    className="w-[250px] h-[318px] object-cover rounded-[12px]"
            ...
            <div className="gap-y-[12px] grid">
                ...
                <Link className="mb-[20px] flex justify-center items-center px-[14px] py-[2px] bg-[--primary] font-bold rounded-[6px] hover:opacity-[0.9] text-[2rem] cursor-pointer w-[200px]">
                    Watch Now
                </Link>
            </div>
        </div>
