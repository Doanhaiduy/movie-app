        ...
        .map((item, index) => (
            <div key={index} className="">
                ...
                <div className="p-[20px] overflow-hidden grid grid-cols-4 sm:grid-cols-4 gap-x-[12px] mx-auto sm:h-[360px] lg:w-[70vw] border-[1px]">
                    <div class=" sm:h-[100%] ml-[5%] sm:ml-0 w-[90%] h-[50vh] object-cover rounded-[12px] col-span-4 sm:col-span-1">
                        <Skeleton height={'100%'} width={'100%'} />
                    </div>

                    <div class="flex flex-col gap-y-[12px] justify-center col-span-2 sm:col-span-1 ml-[10%] max-w-[150px]">
                        <Skeleton height={27} className="mt-[20px]" />
                        <Skeleton height={27} className="mt-[20px]" />
                        <Skeleton height={27} className="mt-[20px]" />
                        <Skeleton height={27} className="mt-[20px]" />
                    </div>
                    <div class="flex flex-col gap-y-[12px] justify-center col-span-2 sm:col-span-1 ml-[10px] max-w-[150px]">
                        <Skeleton height={27} className="mt-[20px]" />
                        <Skeleton height={27} className="mt-[20px]" />
                        <Skeleton height={27} className="mt-[20px]" />
                        <Skeleton height={27} className="mt-[20px]" />
                    </div>
                    <div class="flex justify-center sm:items-center flex-row col-span-4 mt-[24px] gap-x-6 sm:col-span-1 sm:flex-col  ">
                        <Skeleton
